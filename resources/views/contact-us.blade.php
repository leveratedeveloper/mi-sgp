...
@section('content')
    ...
    <div class="container-fluid pt-5 d-none d-md-block">
        <div class="row">
            <div class="col-md-6 m-auto" style="padding-left:150px;">
            <h2 class="h2-bold"><span class="highlight-yellow">Contact</span> Us.</h2>
                    <p class="py-3">Mandiri Investment Management Pte. Ltd.<br>
                    Asia Square Tower 2 #19-05<br>
                    12 Marina View, Singapore 018961
                    </p>
                    <p>
                        <a href="mailto:info@mandiri-investment.com.sg" class="link-offset-2 link-underline link-underline-opacity-0 link-sky-blue shortcut_link">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#67B2E8" height="16px" width="16px" version="1.1" id="Layer_1" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve">
                        ...
                        info@mandiri-investment.com.sg</a><br>
                        <a href="https://www.google.com/maps?q=12+Marina+View,+Singapore+018961" class="link-offset-2 link-underline link-underline-opacity-0 link-sky-blue shortcut_link pt-2" target="_blank">📍 View on Google Map</a>
                    </p>
            </div>
            <div class="col-md-6">
                <img src="{{ asset('images/image03-contact-us.webp') }}" alt="Contact Us" class="img-fluid">
            </div>
        </div>
    ...
    <div class="container-fluid pt-5 d-md-none d-sm-block">
        <div class="row">
